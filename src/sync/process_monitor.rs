...
impl ProcessMonitor {
    ...
    pub async fn start_monitoring(&self) -> Result<()> {
        info!("Starting process monitor with {}s check interval", self.check_interval.as_secs());
    ...
    fn get_process_start_time(&self, pid: u32) -> Result<Duration> {
        ...
        let output = Command::new("ps")
            ...
            .output()
            .map_err(|e| crate::SnapRagError::Custom(format!("Failed to get process start time: {}", e)))?;
