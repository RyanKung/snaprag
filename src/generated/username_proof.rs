...
pub enum UserNameType {
    ...
    // @@protoc_insertion_point(enum_value:UserNameType.USERNAME_TYPE_BASENAME)
...
impl ::protobuf::Enum for UserNameType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<UserNameType> {
        match str {
            ...
            "USERNAME_TYPE_BASENAME" => ::std::option::Option::Some(UserNameType::USERNAME_TYPE_BASENAME),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x10\x02\x12\x1a\n\x16USERNAME_TYPE_BASENAME\x10\x03b\x06proto3\
";
