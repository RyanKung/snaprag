...
impl MessageData {
    ...
    pub fn link_compact_state_body(&self) -> &LinkCompactStateBody {
        match self.body {
            ::std::option::Option::Some(message_data::Body::LinkCompactStateBody(ref v)) => v,
    ...
    pub fn has_link_compact_state_body(&self) -> bool {
        match self.body {
            ::std::option::Option::Some(message_data::Body::LinkCompactStateBody(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_link_compact_state_body(&mut self, v: LinkCompactStateBody) {
        self.body = ::std::option::Option::Some(message_data::Body::LinkCompactStateBody(v))
    }

    // Mutable pointer to the field.
    pub fn mut_link_compact_state_body(&mut self) -> &mut LinkCompactStateBody {
        if let ::std::option::Option::Some(message_data::Body::LinkCompactStateBody(_)) = self.body {
        } else {
            self.body = ::std::option::Option::Some(message_data::Body::LinkCompactStateBody(LinkCompactStateBody::new()));
        }
        match self.body {
            ::std::option::Option::Some(message_data::Body::LinkCompactStateBody(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_link_compact_state_body(&mut self) -> LinkCompactStateBody {
        if self.has_link_compact_state_body() {
            match self.body.take() {
                ::std::option::Option::Some(message_data::Body::LinkCompactStateBody(v)) => v,
                _ => panic!(),
            }
        } else {
    ...
    pub fn lend_storage_body(&self) -> &LendStorageBody {
        match self.body {
            ::std::option::Option::Some(message_data::Body::LendStorageBody(ref v)) => v,
            _ => <LendStorageBody as ::protobuf::Message>::default_instance(),
        }
    }

    pub fn clear_lend_storage_body(&mut self) {
        self.body = ::std::option::Option::None;
    }

    pub fn has_lend_storage_body(&self) -> bool {
        match self.body {
            ::std::option::Option::Some(message_data::Body::LendStorageBody(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_lend_storage_body(&mut self, v: LendStorageBody) {
        self.body = ::std::option::Option::Some(message_data::Body::LendStorageBody(v))
    }

    // Mutable pointer to the field.
    pub fn mut_lend_storage_body(&mut self) -> &mut LendStorageBody {
        if let ::std::option::Option::Some(message_data::Body::LendStorageBody(_)) = self.body {
        } else {
            self.body = ::std::option::Option::Some(message_data::Body::LendStorageBody(LendStorageBody::new()));
        }
        match self.body {
            ::std::option::Option::Some(message_data::Body::LendStorageBody(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_lend_storage_body(&mut self) -> LendStorageBody {
        if self.has_lend_storage_body() {
            match self.body.take() {
                ::std::option::Option::Some(message_data::Body::LendStorageBody(v)) => v,
                _ => panic!(),
            }
        } else {
            LendStorageBody::new()
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, LinkCompactStateBody>(
            "link_compact_state_body",
            MessageData::has_link_compact_state_body,
            MessageData::link_compact_state_body,
            MessageData::mut_link_compact_state_body,
            MessageData::set_link_compact_state_body,
        ));
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, LendStorageBody>(
            "lend_storage_body",
            MessageData::has_lend_storage_body,
            MessageData::lend_storage_body,
            MessageData::mut_lend_storage_body,
            MessageData::set_lend_storage_body,
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                138 => {
                    self.body = ::std::option::Option::Some(message_data::Body::LinkCompactStateBody(is.read_message()?));
                },
                146 => {
                    self.body = ::std::option::Option::Some(message_data::Body::LendStorageBody(is.read_message()?));
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let ::std::option::Option::Some(ref v) = self.body {
            match v {
                ...
                &message_data::Body::LinkCompactStateBody(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
                &message_data::Body::LendStorageBody(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
            };
...
pub mod message_data {
    ...
    pub enum Body {
        ...
        // @@protoc_insertion_point(oneof_field:MessageData.link_compact_state_body)
        LinkCompactStateBody(super::LinkCompactStateBody),
        // @@protoc_insertion_point(oneof_field:MessageData.lend_storage_body)
...
pub struct CastAddBody {
    ...
    // @@protoc_insertion_point(field:CastAddBody.type)
    pub type_: ::protobuf::EnumOrUnknown<CastType>,
    // message oneof groups
...
impl CastAddBody {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "type",
            |m: &CastAddBody| { &m.type_ },
            |m: &mut CastAddBody| { &mut m.type_ },
        ));
...
impl ::protobuf::Message for CastAddBody {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint64_size(2, &self.mentions);
        if !self.text.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.text);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.mentions_positions);
        for value in &self.embeds {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        };
        if self.type_ != ::protobuf::EnumOrUnknown::new(CastType::CAST) {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint64(2, &self.mentions)?;
        if !self.text.is_empty() {
            os.write_string(4, &self.text)?;
        }
        os.write_repeated_packed_uint32(5, &self.mentions_positions)?;
    ...
    fn clear(&mut self) {
        ...
        self.embeds.clear();
        self.type_ = ::protobuf::EnumOrUnknown::new(CastType::CAST);
        self.special_fields.clear();
    }
...
// @@protoc_insertion_point(message:LinkCompactStateBody)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LinkCompactStateBody {
    // message fields
    // @@protoc_insertion_point(field:LinkCompactStateBody.type)
    pub type_: ::std::string::String,
    // @@protoc_insertion_point(field:LinkCompactStateBody.target_fids)
    pub target_fids: ::std::vec::Vec<u64>,
    // special fields
    // @@protoc_insertion_point(special_field:LinkCompactStateBody.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl LinkCompactStateBody {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "type",
            |m: &LinkCompactStateBody| { &m.type_ },
            |m: &mut LinkCompactStateBody| { &mut m.type_ },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "target_fids",
        ...
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<LinkCompactStateBody>(
...
impl ::protobuf::Message for LinkCompactStateBody {
    const NAME: &'static str = "LinkCompactStateBody";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    is.read_repeated_packed_uint64_into(&mut self.target_fids)?;
                },
                16 => {
                    self.target_fids.push(is.read_uint64()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint64_size(2, &self.target_fids);
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint64(2, &self.target_fids)?;
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn default_instance() -> &'static LinkCompactStateBody {
        static instance: LinkCompactStateBody = LinkCompactStateBody {
            type_: ::std::string::String::new(),
            target_fids: ::std::vec::Vec::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl ::protobuf::MessageFull for LinkCompactStateBody {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LinkCompactStateBody").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LinkCompactStateBody {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
// @@protoc_insertion_point(message:LendStorageBody)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LendStorageBody {
    // message fields
    // @@protoc_insertion_point(field:LendStorageBody.to_fid)
    pub to_fid: u64,
    // @@protoc_insertion_point(field:LendStorageBody.num_units)
    pub num_units: u64,
    // @@protoc_insertion_point(field:LendStorageBody.unit_type)
    pub unit_type: ::protobuf::EnumOrUnknown<StorageUnitType>,
    // special fields
    // @@protoc_insertion_point(special_field:LendStorageBody.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a LendStorageBody {
    fn default() -> &'a LendStorageBody {
        <LendStorageBody as ::protobuf::Message>::default_instance()
    }
}

impl LendStorageBody {
    pub fn new() -> LendStorageBody {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "to_fid",
            |m: &LendStorageBody| { &m.to_fid },
            |m: &mut LendStorageBody| { &mut m.to_fid },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "num_units",
            |m: &LendStorageBody| { &m.num_units },
            |m: &mut LendStorageBody| { &mut m.num_units },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "unit_type",
            |m: &LendStorageBody| { &m.unit_type },
            |m: &mut LendStorageBody| { &mut m.unit_type },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<LendStorageBody>(
            "LendStorageBody",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for LendStorageBody {
    const NAME: &'static str = "LendStorageBody";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.to_fid = is.read_uint64()?;
                },
                16 => {
                    self.num_units = is.read_uint64()?;
                },
                24 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.to_fid != 0 {
            my_size += ::protobuf::rt::uint64_size(1, self.to_fid);
        }
        if self.num_units != 0 {
            my_size += ::protobuf::rt::uint64_size(2, self.num_units);
        }
        if self.unit_type != ::protobuf::EnumOrUnknown::new(StorageUnitType::UNIT_TYPE_LEGACY) {
            my_size += ::protobuf::rt::int32_size(3, self.unit_type.value());
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.to_fid != 0 {
            os.write_uint64(1, self.to_fid)?;
        }
        if self.num_units != 0 {
            os.write_uint64(2, self.num_units)?;
        }
        if self.unit_type != ::protobuf::EnumOrUnknown::new(StorageUnitType::UNIT_TYPE_LEGACY) {
            os.write_enum(3, ::protobuf::EnumOrUnknown::value(&self.unit_type))?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn clear(&mut self) {
        self.to_fid = 0;
        self.num_units = 0;
        self.unit_type = ::protobuf::EnumOrUnknown::new(StorageUnitType::UNIT_TYPE_LEGACY);
        self.special_fields.clear();
    }

    fn default_instance() -> &'static LendStorageBody {
        static instance: LendStorageBody = LendStorageBody {
            to_fid: 0,
            num_units: 0,
...
impl ::protobuf::MessageFull for LendStorageBody {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LendStorageBody").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LendStorageBody {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LendStorageBody {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
pub enum MessageType {
    ...
    // @@protoc_insertion_point(enum_value:MessageType.MESSAGE_TYPE_LINK_COMPACT_STATE)
    MESSAGE_TYPE_LINK_COMPACT_STATE = 14,
    // @@protoc_insertion_point(enum_value:MessageType.MESSAGE_TYPE_LEND_STORAGE)
...
impl ::protobuf::Enum for MessageType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<MessageType> {
        match value {
            ...
            15 => ::std::option::Option::Some(MessageType::MESSAGE_TYPE_LEND_STORAGE),
            _ => ::std::option::Option::None
        }
    }
    ...
    fn from_str(str: &str) -> ::std::option::Option<MessageType> {
        match str {
            ...
            "MESSAGE_TYPE_LINK_COMPACT_STATE" => ::std::option::Option::Some(MessageType::MESSAGE_TYPE_LINK_COMPACT_STATE),
            "MESSAGE_TYPE_LEND_STORAGE" => ::std::option::Option::Some(MessageType::MESSAGE_TYPE_LEND_STORAGE),
            _ => ::std::option::Option::None
        }
    }
    ...
    const VALUES: &'static [MessageType] = &[
        ...
        MessageType::MESSAGE_TYPE_LEND_STORAGE,
    ];
}
...
impl ::protobuf::EnumFull for MessageType {
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ...
            MessageType::MESSAGE_TYPE_LINK_COMPACT_STATE => 12,
            MessageType::MESSAGE_TYPE_LEND_STORAGE => 13,
        };
        Self::enum_descriptor().value_by_index(index)
    }
}
...
pub enum UserDataType {
    ...
    // @@protoc_insertion_point(enum_value:UserDataType.USER_DATA_TYPE_LOCATION)
    USER_DATA_TYPE_LOCATION = 7,
    // @@protoc_insertion_point(enum_value:UserDataType.USER_DATA_TYPE_TWITTER)
    USER_DATA_TYPE_TWITTER = 8,
    // @@protoc_insertion_point(enum_value:UserDataType.USER_DATA_TYPE_GITHUB)
    USER_DATA_TYPE_GITHUB = 9,
    // @@protoc_insertion_point(enum_value:UserDataType.USER_DATA_TYPE_BANNER)
    USER_DATA_TYPE_BANNER = 10,
    // @@protoc_insertion_point(enum_value:UserDataType.USER_DATA_PRIMARY_ADDRESS_ETHEREUM)
    USER_DATA_PRIMARY_ADDRESS_ETHEREUM = 11,
    // @@protoc_insertion_point(enum_value:UserDataType.USER_DATA_PRIMARY_ADDRESS_SOLANA)
    USER_DATA_PRIMARY_ADDRESS_SOLANA = 12,
    // @@protoc_insertion_point(enum_value:UserDataType.USER_DATA_TYPE_PROFILE_TOKEN)
...
impl ::protobuf::Enum for UserDataType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<UserDataType> {
        match str {
            ...
            "USER_DATA_TYPE_LOCATION" => ::std::option::Option::Some(UserDataType::USER_DATA_TYPE_LOCATION),
            "USER_DATA_TYPE_TWITTER" => ::std::option::Option::Some(UserDataType::USER_DATA_TYPE_TWITTER),
            "USER_DATA_TYPE_GITHUB" => ::std::option::Option::Some(UserDataType::USER_DATA_TYPE_GITHUB),
            "USER_DATA_TYPE_BANNER" => ::std::option::Option::Some(UserDataType::USER_DATA_TYPE_BANNER),
            "USER_DATA_PRIMARY_ADDRESS_ETHEREUM" => ::std::option::Option::Some(UserDataType::USER_DATA_PRIMARY_ADDRESS_ETHEREUM),
            "USER_DATA_PRIMARY_ADDRESS_SOLANA" => ::std::option::Option::Some(UserDataType::USER_DATA_PRIMARY_ADDRESS_SOLANA),
            "USER_DATA_TYPE_PROFILE_TOKEN" => ::std::option::Option::Some(UserDataType::USER_DATA_TYPE_PROFILE_TOKEN),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::EnumFull for UserDataType {
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ...
            UserDataType::USER_DATA_TYPE_LOCATION => 6,
            UserDataType::USER_DATA_TYPE_TWITTER => 7,
            UserDataType::USER_DATA_TYPE_GITHUB => 8,
            UserDataType::USER_DATA_TYPE_BANNER => 9,
            UserDataType::USER_DATA_PRIMARY_ADDRESS_ETHEREUM => 10,
            UserDataType::USER_DATA_PRIMARY_ADDRESS_SOLANA => 11,
            UserDataType::USER_DATA_TYPE_PROFILE_TOKEN => 12,
        };
        Self::enum_descriptor().value_by_index(index)
    }
}
...
#[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
// @@protoc_insertion_point(enum:CastType)
pub enum CastType {
    // @@protoc_insertion_point(enum_value:CastType.CAST)
    CAST = 0,
    // @@protoc_insertion_point(enum_value:CastType.LONG_CAST)
    LONG_CAST = 1,
    // @@protoc_insertion_point(enum_value:CastType.TEN_K_CAST)
    TEN_K_CAST = 2,
}

impl ::protobuf::Enum for CastType {
    const NAME: &'static str = "CastType";
    ...
    fn from_str(str: &str) -> ::std::option::Option<CastType> {
        match str {
            "CAST" => ::std::option::Option::Some(CastType::CAST),
            "LONG_CAST" => ::std::option::Option::Some(CastType::LONG_CAST),
            "TEN_K_CAST" => ::std::option::Option::Some(CastType::TEN_K_CAST),
            _ => ::std::option::Option::None
        }
    }

    const VALUES: &'static [CastType] = &[
        CastType::CAST,
        CastType::LONG_CAST,
        CastType::TEN_K_CAST,
    ];
...
impl ::protobuf::EnumFull for CastType {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("CastType").unwrap()).clone()
    }
...
impl CastType {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<CastType>("CastType")
    }
}
...
#[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
// @@protoc_insertion_point(enum:StorageUnitType)
pub enum StorageUnitType {
    // @@protoc_insertion_point(enum_value:StorageUnitType.UNIT_TYPE_LEGACY)
    UNIT_TYPE_LEGACY = 0,
    // @@protoc_insertion_point(enum_value:StorageUnitType.UNIT_TYPE_2024)
    UNIT_TYPE_2024 = 1,
    // @@protoc_insertion_point(enum_value:StorageUnitType.UNIT_TYPE_2025)
    UNIT_TYPE_2025 = 2,
}

impl ::protobuf::Enum for StorageUnitType {
    const NAME: &'static str = "StorageUnitType";

    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<StorageUnitType> {
        match value {
            0 => ::std::option::Option::Some(StorageUnitType::UNIT_TYPE_LEGACY),
            1 => ::std::option::Option::Some(StorageUnitType::UNIT_TYPE_2024),
            2 => ::std::option::Option::Some(StorageUnitType::UNIT_TYPE_2025),
            _ => ::std::option::Option::None
        }
    }

    fn from_str(str: &str) -> ::std::option::Option<StorageUnitType> {
        match str {
            "UNIT_TYPE_LEGACY" => ::std::option::Option::Some(StorageUnitType::UNIT_TYPE_LEGACY),
            "UNIT_TYPE_2024" => ::std::option::Option::Some(StorageUnitType::UNIT_TYPE_2024),
            "UNIT_TYPE_2025" => ::std::option::Option::Some(StorageUnitType::UNIT_TYPE_2025),
            _ => ::std::option::Option::None
        }
    }

    const VALUES: &'static [StorageUnitType] = &[
        StorageUnitType::UNIT_TYPE_LEGACY,
        StorageUnitType::UNIT_TYPE_2024,
        StorageUnitType::UNIT_TYPE_2025,
    ];
}

impl ::protobuf::EnumFull for StorageUnitType {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("StorageUnitType").unwrap()).clone()
    }
...
impl ::std::default::Default for StorageUnitType {
    fn default() -> Self {
        StorageUnitType::UNIT_TYPE_LEGACY
    }
}
...
impl StorageUnitType {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<StorageUnitType>("StorageUnitType")
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0b2\x10.FrameActionBodyH\0R\x0fframeActionBody\x12N\n\x17link_compact_\
    state_body\x18\x11\x20\x01(\x0b2\x15.LinkCompactStateBodyH\0R\x14linkCom\
    pactStateBody\x12>\n\x11lend_storage_body\x18\x12\x20\x01(\x0b2\x10.Lend\
    StorageBodyH\0R\x0flendStorageBodyB\x06\n\x04body\"G\n\x0cUserDataBody\
    \x12!\n\x04type\x18\x01\x20\x01(\x0e2\r.UserDataTypeR\x04type\x12\x14\n\
    \x05value\x18\x02\x20\x01(\tR\x05value\"H\n\x05Embed\x12\x12\n\x03url\
    \x18\x01\x20\x01(\tH\0R\x03url\x12\"\n\x07cast_id\x18\x02\x20\x01(\x0b2\
    \x07.CastIdH\0R\x06castIdB\x07\n\x05embed\"\xb4\x02\n\x0bCastAddBody\x12\
    +\n\x11embeds_deprecated\x18\x01\x20\x03(\tR\x10embedsDeprecated\x12\x1a\
    \n\x08mentions\x18\x02\x20\x03(\x04R\x08mentions\x12/\n\x0eparent_cast_i\
    d\x18\x03\x20\x01(\x0b2\x07.CastIdH\0R\x0cparentCastId\x12\x1f\n\nparent\
    _url\x18\x07\x20\x01(\tH\0R\tparentUrl\x12\x12\n\x04text\x18\x04\x20\x01\
    (\tR\x04text\x12-\n\x12mentions_positions\x18\x05\x20\x03(\rR\x11mention\
    sPositions\x12\x1e\n\x06embeds\x18\x06\x20\x03(\x0b2\x06.EmbedR\x06embed\
    s\x12\x1d\n\x04type\x18\x08\x20\x01(\x0e2\t.CastTypeR\x04typeB\x08\n\x06\
    parent\"1\n\x0eCastRemoveBody\x12\x1f\n\x0btarget_hash\x18\x01\x20\x01(\
    \x0cR\ntargetHash\".\n\x06CastId\x12\x10\n\x03fid\x18\x01\x20\x01(\x04R\
    \x03fid\x12\x12\n\x04hash\x18\x02\x20\x01(\x0cR\x04hash\"\x8d\x01\n\x0cR\
    eactionBody\x12!\n\x04type\x18\x01\x20\x01(\x0e2\r.ReactionTypeR\x04type\
    \x12/\n\x0etarget_cast_id\x18\x02\x20\x01(\x0b2\x07.CastIdH\0R\x0ctarget\
    CastId\x12\x1f\n\ntarget_url\x18\x03\x20\x01(\tH\0R\ttargetUrlB\x08\n\
    \x06target\"\xed\x01\n\x1aVerificationAddAddressBody\x12\x18\n\x07addres\
    s\x18\x01\x20\x01(\x0cR\x07address\x12'\n\x0fclaim_signature\x18\x02\x20\
    \x01(\x0cR\x0eclaimSignature\x12\x1d\n\nblock_hash\x18\x03\x20\x01(\x0cR\
    \tblockHash\x12+\n\x11verification_type\x18\x04\x20\x01(\rR\x10verificat\
    ionType\x12\x19\n\x08chain_id\x18\x05\x20\x01(\rR\x07chainId\x12%\n\x08p\
    rotocol\x18\x07\x20\x01(\x0e2\t.ProtocolR\x08protocol\"Y\n\x16Verificati\
    onRemoveBody\x12\x18\n\x07address\x18\x01\x20\x01(\x0cR\x07address\x12%\
    \n\x08protocol\x18\x02\x20\x01(\x0e2\t.ProtocolR\x08protocol\"\x8f\x01\n\
    \x08LinkBody\x12\x12\n\x04type\x18\x01\x20\x01(\tR\x04type\x12/\n\x10dis\
    playTimestamp\x18\x02\x20\x01(\rH\0R\x10displayTimestamp\x88\x01\x01\x12\
    \x1f\n\ntarget_fid\x18\x03\x20\x01(\x04H\x01R\ttargetFidB\x13\n\x11_disp\
    layTimestampB\x08\n\x06target\"K\n\x14LinkCompactStateBody\x12\x12\n\x04\
    type\x18\x01\x20\x01(\tR\x04type\x12\x1f\n\x0btarget_fids\x18\x02\x20\
    \x03(\x04R\ntargetFids\"\xde\x01\n\x0fFrameActionBody\x12\x10\n\x03url\
    \x18\x01\x20\x01(\x0cR\x03url\x12!\n\x0cbutton_index\x18\x02\x20\x01(\rR\
    \x0bbuttonIndex\x12\x20\n\x07cast_id\x18\x03\x20\x01(\x0b2\x07.CastIdR\
    \x06castId\x12\x1d\n\ninput_text\x18\x04\x20\x01(\x0cR\tinputText\x12\
    \x14\n\x05state\x18\x05\x20\x01(\x0cR\x05state\x12%\n\x0etransaction_id\
    \x18\x06\x20\x01(\x0cR\rtransactionId\x12\x18\n\x07address\x18\x07\x20\
    \x01(\x0cR\x07address\"t\n\x0fLendStorageBody\x12\x15\n\x06to_fid\x18\
    \x01\x20\x01(\x04R\x05toFid\x12\x1b\n\tnum_units\x18\x02\x20\x01(\x04R\
    \x08numUnits\x12-\n\tunit_type\x18\x03\x20\x01(\x0e2\x10.StorageUnitType\
    R\x08unitType*:\n\nHashScheme\x12\x14\n\x10HASH_SCHEME_NONE\x10\0\x12\
    \x16\n\x12HASH_SCHEME_BLAKE3\x10\x01*g\n\x0fSignatureScheme\x12\x19\n\
    \x15SIGNATURE_SCHEME_NONE\x10\0\x12\x1c\n\x18SIGNATURE_SCHEME_ED25519\
    \x10\x01\x12\x1b\n\x17SIGNATURE_SCHEME_EIP712\x10\x02*\xd0\x03\n\x0bMess\
    ageType\x12\x15\n\x11MESSAGE_TYPE_NONE\x10\0\x12\x19\n\x15MESSAGE_TYPE_C\
    AST_ADD\x10\x01\x12\x1c\n\x18MESSAGE_TYPE_CAST_REMOVE\x10\x02\x12\x1d\n\
    \x19MESSAGE_TYPE_REACTION_ADD\x10\x03\x12\x20\n\x1cMESSAGE_TYPE_REACTION\
    _REMOVE\x10\x04\x12\x19\n\x15MESSAGE_TYPE_LINK_ADD\x10\x05\x12\x1c\n\x18\
    MESSAGE_TYPE_LINK_REMOVE\x10\x06\x12-\n)MESSAGE_TYPE_VERIFICATION_ADD_ET\
    H_ADDRESS\x10\x07\x12$\n\x20MESSAGE_TYPE_VERIFICATION_REMOVE\x10\x08\x12\
    \x1e\n\x1aMESSAGE_TYPE_USER_DATA_ADD\x10\x0b\x12\x1f\n\x1bMESSAGE_TYPE_U\
    SERNAME_PROOF\x10\x0c\x12\x1d\n\x19MESSAGE_TYPE_FRAME_ACTION\x10\r\x12#\
    \n\x1fMESSAGE_TYPE_LINK_COMPACT_STATE\x10\x0e\x12\x1d\n\x19MESSAGE_TYPE_\
    LEND_STORAGE\x10\x0f*\x8a\x01\n\x10FarcasterNetwork\x12\x1a\n\x16FARCAST\
    ER_NETWORK_NONE\x10\0\x12\x1d\n\x19FARCASTER_NETWORK_MAINNET\x10\x01\x12\
    \x1d\n\x19FARCASTER_NETWORK_TESTNET\x10\x02\x12\x1c\n\x18FARCASTER_NETWO\
    RK_DEVNET\x10\x03*\x87\x03\n\x0cUserDataType\x12\x17\n\x13USER_DATA_TYPE\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(LinkCompactStateBody::generated_message_descriptor_data());
            messages.push(FrameActionBody::generated_message_descriptor_data());
            messages.push(LendStorageBody::generated_message_descriptor_data());
            ...
            enums.push(CastType::generated_enum_descriptor_data());
            enums.push(ReactionType::generated_enum_descriptor_data());
            enums.push(Protocol::generated_enum_descriptor_data());
            enums.push(StorageUnitType::generated_enum_descriptor_data());
