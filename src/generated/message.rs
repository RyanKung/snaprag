...
impl MessageData {
    ...
    pub fn get_lend_storage_body(&self) -> &LendStorageBody {
        match self.body {
            ::std::option::Option::Some(MessageData_oneof_body::lend_storage_body(ref v)) => v,
    ...
    pub fn has_lend_storage_body(&self) -> bool {
        match self.body {
            ::std::option::Option::Some(MessageData_oneof_body::lend_storage_body(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_lend_storage_body(&mut self, v: LendStorageBody) {
        self.body = ::std::option::Option::Some(MessageData_oneof_body::lend_storage_body(v))
    }

    // Mutable pointer to the field.
    pub fn mut_lend_storage_body(&mut self) -> &mut LendStorageBody {
        if let ::std::option::Option::Some(MessageData_oneof_body::lend_storage_body(_)) = self.body {
        } else {
            self.body = ::std::option::Option::Some(MessageData_oneof_body::lend_storage_body(LendStorageBody::new()));
        }
        match self.body {
            ::std::option::Option::Some(MessageData_oneof_body::lend_storage_body(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_lend_storage_body(&mut self) -> LendStorageBody {
        if self.has_lend_storage_body() {
            match self.body.take() {
                ::std::option::Option::Some(MessageData_oneof_body::lend_storage_body(v)) => v,
                _ => panic!(),
            }
        } else {
            LendStorageBody::new()
...
impl ::protobuf::Message for MessageData {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(MessageData_oneof_body::lend_storage_body(ref v)) = self.body {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                18 => {
                    ...
                    self.body = ::std::option::Option::Some(MessageData_oneof_body::lend_storage_body(is.read_message()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.body {
            match v {
                ...
                &MessageData_oneof_body::lend_storage_body(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
            };
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, LendStorageBody>(
                "lend_storage_body",
                MessageData::has_lend_storage_body,
                MessageData::get_lend_storage_body,
            ));
...
impl LendStorageBody {
    ...
    pub fn get_to_fid(&self) -> u64 {
        self.to_fid
    }
    pub fn clear_to_fid(&mut self) {
        self.to_fid = 0;
    }

    // Param is passed by value, moved
    pub fn set_to_fid(&mut self, v: u64) {
        self.to_fid = v;
    }
    ...
    pub fn get_num_units(&self) -> u64 {
        self.num_units
    }
    pub fn clear_num_units(&mut self) {
        self.num_units = 0;
    }

    // Param is passed by value, moved
    pub fn set_num_units(&mut self, v: u64) {
        self.num_units = v;
    }
    ...
    pub fn get_unit_type(&self) -> StorageUnitType {
        self.unit_type
    }
    pub fn clear_unit_type(&mut self) {
        self.unit_type = StorageUnitType::UNIT_TYPE_LEGACY;
    }

    // Param is passed by value, moved
    pub fn set_unit_type(&mut self, v: StorageUnitType) {
        self.unit_type = v;
    }
}
...
impl ::protobuf::Message for LendStorageBody {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_proto3_enum_with_unknown_fields_into(wire_type, is, &mut self.unit_type, 3, &mut self.unknown_fields)?
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if self.to_fid != 0 {
            my_size += ::protobuf::rt::value_size(1, self.to_fid, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.num_units != 0 {
            my_size += ::protobuf::rt::value_size(2, self.num_units, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.unit_type != StorageUnitType::UNIT_TYPE_LEGACY {
            my_size += ::protobuf::rt::enum_size(3, self.unit_type);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.unit_type != StorageUnitType::UNIT_TYPE_LEGACY {
            os.write_enum(3, ::protobuf::ProtobufEnum::value(&self.unit_type))?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<StorageUnitType>>(
                "unit_type",
                |m: &LendStorageBody| { &m.unit_type },
                |m: &mut LendStorageBody| { &mut m.unit_type },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<LendStorageBody>(
                "LendStorageBody",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static LendStorageBody {
        static instance: ::protobuf::rt::LazyV2<LendStorageBody> = ::protobuf::rt::LazyV2::INIT;
        instance.get(LendStorageBody::new)
    }
}

impl ::protobuf::Clear for LendStorageBody {
    fn clear(&mut self) {
        self.to_fid = 0;
        self.num_units = 0;
        self.unit_type = StorageUnitType::UNIT_TYPE_LEGACY;
...
impl ::std::fmt::Debug for LendStorageBody {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
impl ::protobuf::ProtobufEnum for StorageUnitType {
    fn value(&self) -> i32 {
        *self as i32
    }
    ...
    fn values() -> &'static [Self] {
        static values: &'static [StorageUnitType] = &[
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<StorageUnitType>("StorageUnitType", file_descriptor_proto())
        })
    }
}

impl ::std::marker::Copy for StorageUnitType {
}
...
impl ::protobuf::reflect::ProtobufValue for StorageUnitType {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Enum(::protobuf::ProtobufEnum::descriptor(self))
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\x0cR\tdataBytesB\0:\0\"\x85\x07\n\x0bMessageData\x12\"\n\x04type\
    ...
    pactStateBodyH\0R\x14linkCompactStateBodyB\0\x12@\n\x11lend_storage_body\
    \x18\x12\x20\x01(\x0b2\x10.LendStorageBodyH\0R\x0flendStorageBodyB\0B\
    \x06\n\x04body:\0\"M\n\x0cUserDataBody\x12#\n\x04type\x18\x01\x20\x01(\
    \x0e2\r.UserDataTypeR\x04typeB\0\x12\x16\n\x05value\x18\x02\x20\x01(\tR\
    \x05valueB\0:\0\"N\n\x05Embed\x12\x14\n\x03url\x18\x01\x20\x01(\tH\0R\
    \x03urlB\0\x12$\n\x07cast_id\x18\x02\x20\x01(\x0b2\x07.CastIdH\0R\x06cas\
    tIdB\0B\x07\n\x05embed:\0\"\xc6\x02\n\x0bCastAddBody\x12-\n\x11embeds_de\
    precated\x18\x01\x20\x03(\tR\x10embedsDeprecatedB\0\x12\x1c\n\x08mention\
    s\x18\x02\x20\x03(\x04R\x08mentionsB\0\x121\n\x0eparent_cast_id\x18\x03\
    ...
    edsB\0\x12\x1f\n\x04type\x18\x08\x20\x01(\x0e2\t.CastTypeR\x04typeB\0B\
    \x08\n\x06parent:\0\"5\n\x0eCastRemoveBody\x12!\n\x0btarget_hash\x18\x01\
    \x20\x01(\x0cR\ntargetHashB\0:\0\"4\n\x06CastId\x12\x12\n\x03fid\x18\x01\
    \x20\x01(\x04R\x03fidB\0\x12\x14\n\x04hash\x18\x02\x20\x01(\x0cR\x04hash\
    B\0:\0\"\x95\x01\n\x0cReactionBody\x12#\n\x04type\x18\x01\x20\x01(\x0e2\
    \r.ReactionTypeR\x04typeB\0\x121\n\x0etarget_cast_id\x18\x02\x20\x01(\
    \x0b2\x07.CastIdH\0R\x0ctargetCastIdB\0\x12!\n\ntarget_url\x18\x03\x20\
    \x01(\tH\0R\ttargetUrlB\0B\x08\n\x06target:\0\"\xfb\x01\n\x1aVerificatio\
    nAddAddressBody\x12\x1a\n\x07address\x18\x01\x20\x01(\x0cR\x07addressB\0\
    \x12)\n\x0fclaim_signature\x18\x02\x20\x01(\x0cR\x0eclaimSignatureB\0\
    \x12\x1f\n\nblock_hash\x18\x03\x20\x01(\x0cR\tblockHashB\0\x12-\n\x11ver\
    ification_type\x18\x04\x20\x01(\rR\x10verificationTypeB\0\x12\x1b\n\x08c\
    hain_id\x18\x05\x20\x01(\rR\x07chainIdB\0\x12'\n\x08protocol\x18\x07\x20\
    \x01(\x0e2\t.ProtocolR\x08protocolB\0:\0\"_\n\x16VerificationRemoveBody\
    \x12\x1a\n\x07address\x18\x01\x20\x01(\x0cR\x07addressB\0\x12'\n\x08prot\
    ocol\x18\x02\x20\x01(\x0e2\t.ProtocolR\x08protocolB\0:\0\"}\n\x08LinkBod\
    y\x12\x14\n\x04type\x18\x01\x20\x01(\tR\x04typeB\0\x12,\n\x10displayTime\
    stamp\x18\x02\x20\x01(\rR\x10displayTimestampB\0\x12!\n\ntarget_fid\x18\
    ...
    \x0fLendStorageBody\x12\x17\n\x06to_fid\x18\x01\x20\x01(\x04R\x05toFidB\
    \0\x12\x1d\n\tnum_units\x18\x02\x20\x01(\x04R\x08numUnitsB\0\x12/\n\tuni\
    t_type\x18\x03\x20\x01(\x0e2\x10.StorageUnitTypeR\x08unitTypeB\0:\0*<\n\
    \nHashScheme\x12\x14\n\x10HASH_SCHEME_NONE\x10\0\x12\x16\n\x12HASH_SCHEM\
    E_BLAKE3\x10\x01\x1a\0*i\n\x0fSignatureScheme\x12\x19\n\x15SIGNATURE_SCH\
    EME_NONE\x10\0\x12\x1c\n\x18SIGNATURE_SCHEME_ED25519\x10\x01\x12\x1b\n\
    \x17SIGNATURE_SCHEME_EIP712\x10\x02\x1a\0*\xd2\x03\n\x0bMessageType\x12\
    \x15\n\x11MESSAGE_TYPE_NONE\x10\0\x12\x19\n\x15MESSAGE_TYPE_CAST_ADD\x10\
    \x01\x12\x1c\n\x18MESSAGE_TYPE_CAST_REMOVE\x10\x02\x12\x1d\n\x19MESSAGE_\
    TYPE_REACTION_ADD\x10\x03\x12\x20\n\x1cMESSAGE_TYPE_REACTION_REMOVE\x10\
    \x04\x12\x19\n\x15MESSAGE_TYPE_LINK_ADD\x10\x05\x12\x1c\n\x18MESSAGE_TYP\
    E_LINK_REMOVE\x10\x06\x12-\n)MESSAGE_TYPE_VERIFICATION_ADD_ETH_ADDRESS\
    \x10\x07\x12$\n\x20MESSAGE_TYPE_VERIFICATION_REMOVE\x10\x08\x12\x1e\n\
    \x1aMESSAGE_TYPE_USER_DATA_ADD\x10\x0b\x12\x1f\n\x1bMESSAGE_TYPE_USERNAM\
    E_PROOF\x10\x0c\x12\x1d\n\x19MESSAGE_TYPE_FRAME_ACTION\x10\r\x12#\n\x1fM\
    ESSAGE_TYPE_LINK_COMPACT_STATE\x10\x0e\x12\x1d\n\x19MESSAGE_TYPE_LEND_ST\
    ORAGE\x10\x0f\x1a\0*\x8c\x01\n\x10FarcasterNetwork\x12\x1a\n\x16FARCASTE\
    R_NETWORK_NONE\x10\0\x12\x1d\n\x19FARCASTER_NETWORK_MAINNET\x10\x01\x12\
    \x1d\n\x19FARCASTER_NETWORK_TESTNET\x10\x02\x12\x1c\n\x18FARCASTER_NETWO\
    RK_DEVNET\x10\x03\x1a\0*\x89\x03\n\x0cUserDataType\x12\x17\n\x13USER_DAT\
    A_TYPE_NONE\x10\0\x12\x16\n\x12USER_DATA_TYPE_PFP\x10\x01\x12\x1a\n\x16U\
    SER_DATA_TYPE_DISPLAY\x10\x02\x12\x16\n\x12USER_DATA_TYPE_BIO\x10\x03\
    \x12\x16\n\x12USER_DATA_TYPE_URL\x10\x05\x12\x1b\n\x17USER_DATA_TYPE_USE\
    RNAME\x10\x06\x12\x1b\n\x17USER_DATA_TYPE_LOCATION\x10\x07\x12\x1a\n\x16\
    USER_DATA_TYPE_TWITTER\x10\x08\x12\x19\n\x15USER_DATA_TYPE_GITHUB\x10\t\
    \x12\x19\n\x15USER_DATA_TYPE_BANNER\x10\n\x12&\n\"USER_DATA_PRIMARY_ADDR\
    ESS_ETHEREUM\x10\x0b\x12$\n\x20USER_DATA_PRIMARY_ADDRESS_SOLANA\x10\x0c\
    ...
    \x12\x13\n\x0fPROTOCOL_SOLANA\x10\x01\x1a\0*Q\n\x0fStorageUnitType\x12\
    \x14\n\x10UNIT_TYPE_LEGACY\x10\0\x12\x12\n\x0eUNIT_TYPE_2024\x10\x01\x12\
    \x12\n\x0eUNIT_TYPE_2025\x10\x02\x1a\0B\0b\x06proto3\
";
